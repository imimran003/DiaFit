...
web service sleeps after inactivity and may take about a minute to wake. Its
filesystem is ephemeral, which is safe here because the backend does not store
